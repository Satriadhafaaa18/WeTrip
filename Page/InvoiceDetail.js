...
export const InvoiceDetail = () => {
  ...
  const renderFlightCard = (isJapanAirlines = false) => (
    <TouchableOpacity
      ...
      onPress={() =>
        handleCardPress(isJapanAirlines ? "japanAirlines" : "airAsia")
      }
    >
      <View style={styles.airlineHeader}>
        <View style={styles.airlineInfo}>
    ...
    <View style={styles.container}>
      ...
      <ScrollView style={styles.content}>
        {selectedFlight === "japanAirlines" ? (
          ...
          <>
            <TouchableOpacity
              onPress={() => handleFlightCardClick("japanAirlines")}
            >
              {renderFlightCard(true)}
            </TouchableOpacity>
            <TouchableOpacity
              onPress={() => handleFlightCardClick("otherAirlines")}
            >
